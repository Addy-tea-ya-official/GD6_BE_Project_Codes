...
def main():
    L = []
    for root, dirs, files in os.walk('D:/dataset/AOD-Net.pytorch/MIO-TCD_aod_720_480'): 
        L.append(files)
    for file in L[0]:
        img = cv2.imread('D:/dataset/AOD-Net.pytorch/MIO-TCD_aod_720_480/'+file)
        #cv2.imshow('base', img)
        enhanced_image = agcwd(img)
        cv2.imwrite('D:/dataset/aod_agcwd_MIO-TCD_740_480/'+file, enhanced_image)
